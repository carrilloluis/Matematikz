...
\item{Resolver : \scalebox{1.25}{$\Big[\dfrac{x^2 - 2x + 14}{x^2 + 4x + 2}\Big]^{\frac1{2}} + \Big[\dfrac{x^2 + 4x + 2}{x^2 - 2x + 14}\Big]^{\frac1{2}} = 2$}
\\ \\
\begin{tasks}(5)
\task{1}
\task{$\dfrac{5}{2}$}
...
\item{Hallar ``\scalebox{1.2}{$n$}'' de modo que : $(a - b)^2\,x^2 + 2\,(a^2 - b^2)\,x + n = 0$; tenga raíces reales e iguales.
\begin{tasks}(3)
\task{$(a - b)^2$}
\task{$1$}
\task{$a + b$}
...
\item{Hallar el producto de las raíces de la décima ecuación en la serie : \\ $x^2 + x - 1 = 0\,$; $x^2 + 8x - 8 = 0\,$; $x^2 + 27x - 27 = 0\,$; $\ldots$
\begin{tasks}(5)
\task{729}
\task{1000}
\task{-1000}
...
\item{Si $x_1 \wedge x_2$ son raíces de la ecuación : $x^2 + px + q = 0\,;$ \\ Calcular : $(x_1 - 1)(x_2 - 1) - 1$
\begin{tasks}(3)
\task{$q - p$}
\task{$q + p$}
\task{$1$}
